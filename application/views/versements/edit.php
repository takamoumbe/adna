              ...
              <form method="POST" action="<?php echo base_url("versementCreate") ?>">
                ...
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="date" readonly name="date_versement" class="form-control bg-white" id="date_versement" placeholder="Entrer le prénom du paroisien....." value="<?php echo date('Y-m-d') ?>">
