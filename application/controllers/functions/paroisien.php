			...
			<script>
				setTimeout(
					function () { 
						Swal.fire({
							title: 'Echec',
      						text: 'Désolé mais il semblerait que vous ayez toujour un engagement de ce type valide.',
			...
			<script>
				setTimeout(
					function () { 
						Swal.fire({
							title: 'Echec',
      						text: 'Désolé mais pour cette année vous avec déjà atteint le nombre maximal d\'engagements.',
      						allowOutsideClick: false,
						    confirmButtonColor: '#DD6B55',
						    confirmButtonText: 'Oui, je comprend.',
						})
			...
			<script>
				setTimeout(
					function () { 
						Swal.fire({
							title: 'Echec',
      						text: 'Erreur survenue durant la modification des données.',
      						allowOutsideClick: false,
						    confirmButtonColor: '#DD6B55',
						    confirmButtonText: 'Oui, je comprend.',
						})
